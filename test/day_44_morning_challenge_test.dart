...
void main() {
  test('Test Case 1', () {
    ...
    expect(waterCollected([1, 5]), 0);
    expect(waterCollected([5]), 0);
    expect(waterCollected([0]), 0);
    ...
    expect(waterCollected([0,2, 0, 1, 0, 2,0]), 5);
    expect(waterCollected([1,0,2, 0, 1, 0, 2,0,1]), 7);
    expect(waterCollected([0, 1, 0, 2, 1, 0, 1, 3, 2, 1, 2, 1]), 6);
    expect(waterCollected([1, 2, 0, 3, 1, 2, 0, 1]), 4);
    expect(waterCollected([2,1,0,3]), 3);
    expect(waterCollected([]), 0);
  });
}
